...
void loop()
{
  while (!gameFinished)
  {
    ...
    checkTeam(buttonPins2, playerSequences2, currentButtonIndex2, currentButtonIndex2Reverse, "Equipo 2");
  }
...
void checkTeam(int buttonPins[], int playerSequences[], int &currentButtonIndex, int &currentButtonIndexReverse, String teamName)
{
  ...
  {
    if (!gameFinished)
    { // Verifica si el juego ya fue ganado por el otro equipo
      gameFinished = true;
...
void updateTeam(int buttonPins[], int playerSequences[], int &currentButtonIndex, int &currentButtonIndexReverse, String teamName)
{
  ...
  if (buttonPressed != -1)
  {
    ...
    {
      playerSequences[currentButtonIndexReverse] = buttonPressed;
